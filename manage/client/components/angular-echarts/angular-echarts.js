...
function getLinkFunction($http, theme, util, type) {
    return function (scope, element, attrs) {
        ...
        function getOptions(data, config, type) {
            ...
            if(config.xAxis && config.xAxis.type && config.xAxis.type == 'value'){
 ...
 */
angular.module('angular-echarts.theme', []).factory('theme', ['infographic', 'macarons', 'shine', 'dark', 'blue', 'green', 'red','yellow', function (infographic, macarons, shine, dark, blue, green, red,yellow) {
    var themes = {
...
angular.module('angular-echarts.theme').factory('blue', function () {
    return {
        // 默认色板
        color: [
                    '#1790cf','#b6a2de','#5ab1ef','#ffb980','#d87a80',
        ...
        gauge: {
            ...
            axisLine: {
                ...
                lineStyle: {
                    // 属性lineStyle控制线条样式
                    color: [[0.2, '#1790cf'],[0.8, '#5ab1ef'],[1, '#d87a80']],
                    width: 10
                }
            },
            axisTick: {
    ...
    return {
        ...
        map: {
            itemStyle: {
                normal: {
                    areaStyle: { color: '#ddd' },
                    label: { textStyle: { color: '#666666' } },
                    borderWidth:1,//省份的边框宽度
                   borderColor:'#DFDFDF'//省份的边框颜色
                },
                emphasis: {
                    // 也是选中样式
                    areaStyle: { color: '#FA5959' },
                    label: { textStyle: { color: 'rgb(100,0,0)' } }
                }
            }
        },
...
angular.module('angular-echarts.theme').factory('red', function () {
    return {
        // 默认色板
        color: [
                    '#d8361b','#b6a2de','#5ab1ef','#ffb980','#d87a80',
                    '#8d98b3','#e5cf0d','#97b552','#95706d','#dc69aa',
                    '#07a2a4','#9a7fd1','#588dd5','#f5994e','#c05050',
                    '#59678c','#c9ab00','#7eb00a','#6f5553','#c14089'
                ],
        ...
        gauge: {
            ...
            axisLine: {
                ...
                lineStyle: {
                    // 属性lineStyle控制线条样式
                    color: [[0.2, '#d8361b'],[0.8, '#5ab1ef'],[1, '#d87a80']],
                    width: 10
                }
            },
            axisTick: {
...
angular.module('angular-echarts.theme').factory('shine', function () {
      ...
      return {
          // 默认色板
          color: [
                      '#D87A80','#2ec7c9','#b6a2de','#5ab1ef','#ffb980','#d87a80',
                      '#8d98b3','#e5cf0d','#97b552','#95706d','#dc69aa',
                      '#07a2a4','#9a7fd1','#588dd5','#f5994e','#c05050',
                      '#59678c','#7eb00a','#6f5553','#c14089'
                  ],
          // 图表标题
          title: {
              itemGap: 8,
          ...
          timeline: {
              lineStyle: { color: '#D87A80' },
              controlStyle: {
                  normal: { color: '#D87A80' },
                  emphasis: { color: '#D87A80' }
              },
              symbol: 'emptyCircle',
              symbolSize: 3
          },
          ...
          gauge: {
              ...
              axisLine: {
                  ...
                  lineStyle: {
                      // 属性lineStyle控制线条样式
                      color: [[0.2, '#D87A80'],[0.8, '#5ab1ef'],[1, '#d87a80']],
                      width: 10
                  }
              },
              axisTick: {
 ...
 * macarons theme
 */
angular.module('angular-echarts.theme').factory('yellow', function () {
    return {
        // 默认色板
        color: [
                    '#fccc50','#b6a2de','#5ab1ef','#ffb980','#d87a80',
                    '#8d98b3','#e5cf0d','#97b552','#95706d','#dc69aa',
                    '#07a2a4','#9a7fd1','#588dd5','#f5994e','#c05050',
                    '#59678c','#c9ab00','#7eb00a','#6f5553','#c14089'
                ],
        ...
        gauge: {
            ...
            axisLine: {
                ...
                lineStyle: {
                    // 属性lineStyle控制线条样式
                    color: [[0.2, '#fccc50'],[0.8, '#5ab1ef'],[1, '#d87a80']],
                    width: 10
                }
            },
            axisTick: {
