...
app.controller('enterpriseListCtrl', ['$scope', '$http', 'dialog', 'customersManageService', function ($scope, $http, dialog, customersManageService) {
    var vm = this;
    ...
    vm.viewEnterpriseClick = function (eid) {
        $scope.eid = eid;
        dialog.open({
            template: 'app/operationCenter/views/customersManage/enterprise/viewEnterpriselmp.html',
