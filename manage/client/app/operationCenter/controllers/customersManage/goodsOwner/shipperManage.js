...
app.controller('shipperManageCtrl', ['$scope', '$http', 'dialog', 'customersManageService', function ($scope, $http, dialog, customersManageService) {
    var vm = this;
    ...
    vm.viewEnterpriseClick = function (eid) {
        $scope.eid = eid;
        dialog.open({
            template: 'app/operationCenter/views/customersManage/goodsOwner/viewShipper.html',
    ...
    vm.addEnterpriseClick = function () {
        dialog.open({
            template: 'app/operationCenter/views/customersManage/goodsOwner/addShipper.html',
            className: 'ngdialog-theme-default custom-box',
            scope: $scope,
            preCloseCallback: function (data) {
    ...
    vm.editEnterpriseClick = function (eid) {
        $scope.eid = eid;
        dialog.open({
            template: 'app/operationCenter/views/customersManage/goodsOwner/editShipper.html',
            className: 'ngdialog-theme-default custom-box',
            scope: $scope,
            preCloseCallback: function (data) {
                if(data != null && data.code=="200"){
