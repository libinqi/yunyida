...
applicationApp.controller('editApplicationCtrl', ['$scope', 'dialog', 'applicationManageService','Upload', function($scope, dialog, applicationManageService,Upload) {
  var vm = this;
  ...
  vm.updataApplication = function() {
    ...
    applicationManageService.updataApplication($scope.app)
