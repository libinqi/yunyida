var app = angular.module('indexCenterApp');
app.controller('indexChartController', function($scope, indexCenterServices) {
  var vm = this;
vm.query = {
  type:'P'
}
  ...
  vm.getIndexDistribution = function() {
    ...
    indexCenterServices.getIndexDistribution(vm.query.type).then(function(response) {
      if (response.data.code == "200") {
        ...
        if(vm.query.type =='P'){
          $scope.barTitleName = '园区分布';
          $scope.pieTitleName = '分布比例';
          $scope.configMap.dataRange.max = 30;
        }
        // else if(vm.query.type =='E'){
        //   $scope.barTitleName = '地市物流企业分布(家)';
        //   $scope.pieTitleName = '地市物流企业占比(家)';
        //   $scope.configMap.dataRange.max = 200;
        // }else if(vm.query.type =='C'){
        //   $scope.barTitleName = '地市运力分布(吨)';
        //   $scope.pieTitleName = '地市运力比重(吨)';
        //   $scope.configMap.dataRange.max = 300000;
        // }else if(vm.query.type =='D'){
        //   $scope.barTitleName = '地市从业人员分布(名)';
        //   $scope.pieTitleName = '地市从业人员占比(名)';
        //   $scope.configMap.dataRange.max = 10;
        // }else if(vm.query.type =='V'){
        //   $scope.barTitleName = '地市运输工具分布(辆)';
        //   $scope.pieTitleName = '地市运输工具占比(辆)';
        //   $scope.configMap.dataRange.max = 100000;
        // }
