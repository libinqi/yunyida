...
var infoMonitorService = angular.module('supplyMonitorApp').factory('infoMonitorService', ['$http', function ($http) {
  return {
    //信息监测接口
    ...
    getTotalCapacityByTime: function (data) {
        var result = $http.get(loc_host + '/ws/mo/mplatVehicleStatistics/getTotalCapacityByTime',{ params: data}).then(
            function (response) {
                return response;
            },
            function (response) {
    ...
    getCapacityDistributionByPCity: function (data) {
        var result = $http.get(loc_host + '/ws/mo/mplatVehicleStatistics/getCapacityDistributionByPCity',{ params: data}).then(
            function (response) {
                return response;
            },
            function (response) {
